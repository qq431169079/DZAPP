...
#import "DZFakeSearchNavBar.h"
#import "UISearchBar+HPUtil.h"
#import "UIButton+HPUtil.h"

@interface DZFakeSearchNavBar ()<UISearchBarDelegate>
...
@implementation DZFakeSearchNavBar
...
- (UISearchBar *)searchBar {
    if (!_searchBar) {
        ...
        _searchBar.clipCornerRadius = 13.0f;
        _searchBar.layer.cornerRadius = 13.0f;
