...
- (IBAction) btnItemResolutionPressed:(id)sender
{
    ...
    self.resolutionPopup = resolutionPopupView;
...
- (void) updateImage:(id)data
{
    ...
    if (tableCtr != nil &&  tableCtr.butonTap ) {
        ...
        tableCtr.img = self.imageSnapshot;
    }
...
- (void)viewDidLoad {
    ...
    m_bContrastShow = NO;
    //==========================================================
    _recordImgOn = [self fitImage:[UIImage imageNamed:@"ptz_takevideo_pressed"] tofitHeight:35];
    _recordImgOff =[self fitImage:[UIImage imageNamed:@"record"] tofitHeight:35] ;
    _audioImgOn = [self fitImage:[UIImage imageNamed:@"audio"] tofitHeight:35] ;
    _audioImgOff = [self fitImage:[UIImage imageNamed:@"ptz_audio_off"] tofitHeight:35] ;
    _talkImgOn = [self fitImage:[UIImage imageNamed:@"micro_on"] tofitHeight:35];
    _talkImgOff = [self fitImage:[UIImage imageNamed:@"microphone_off"] tofitHeight:35] ;
    ...
    _arrowUpDownImg = [self fitImage:updownImg tofitHeight:30] ;
    CGRect updownBtnFrame = _upDownBtn.frame;
    updownBtnFrame.size = _arrowUpDownImg.size;
    //_upDownBtn.frame = updownBtnFrame;
    
    _arrowLeftRightImg = [self fitImage:leftrightImg tofitHeight:30];
    ...
    _arrowUpDownImgOn = [self fitImage:updownImgOn tofitHeight:30];
    _arrowLeftRightImgOn = [self fitImage:leftrightImgOn tofitHeight:30];
...
//    });
    ...
    CustomToolBarItem* item1 = [[CustomToolBarItem alloc] initwithItemId:11 andTitle:NSLocalizedStringFromTable(@"Contrast", @STR_LOCALIZED_FILE_NAME, nil) andDelegate:self];
    CustomToolBarItem* item2 = [[CustomToolBarItem alloc] initwithItemId:12 andTitle:NSLocalizedStringFromTable(@"Brightness", @STR_LOCALIZED_FILE_NAME, nil) andDelegate:self];
    CustomToolBarItem* item3 = [[CustomToolBarItem alloc] initwithItemId:13 andTitle:[NSString stringWithFormat:@"%@%@",NSLocalizedStringFromTable(@"FocalLength", @STR_LOCALIZED_FILE_NAME, nil),NSLocalizedStringFromTable(@"Zoom", @STR_LOCALIZED_FILE_NAME, nil)] andDelegate:self];
    CustomToolBarItem* item4 = [[CustomToolBarItem alloc] initwithItemId:14 andTitle:[NSString stringWithFormat:@"%@%@",NSLocalizedStringFromTable(@"FocalLength", @STR_LOCALIZED_FILE_NAME, nil),NSLocalizedStringFromTable(@"ZoomOut", @STR_LOCALIZED_FILE_NAME, nil)] andDelegate:self] ;
    CustomToolBarItem* item5 = [[CustomToolBarItem alloc] initwithItemId:15 andTitle:NSLocalizedStringFromTable(@"Vertical", @STR_LOCALIZED_FILE_NAME, nil) andDelegate:self] ;
    CustomToolBarItem* item6 = [[CustomToolBarItem alloc] initwithItemId:16 andTitle:NSLocalizedStringFromTable(@"Horizontal", @STR_LOCALIZED_FILE_NAME, nil) andDelegate:self];
    CustomToolBarItem* item7 = [[CustomToolBarItem alloc] initwithItemId:17 andTitle:[NSString stringWithFormat:@"IR(%@)",NSLocalizedStringFromTable(@"On", @STR_LOCALIZED_FILE_NAME, nil)] andDelegate:self];
    CustomToolBarItem* item8 = [[CustomToolBarItem alloc] initwithItemId:18 andTitle:[NSString stringWithFormat:@"IR(%@)",NSLocalizedStringFromTable(@"Off", @STR_LOCALIZED_FILE_NAME, nil)] andDelegate:self];
...
- (void) YUVNotify:(Byte *)yuv length:(int)length width:(int)width height:(int)height timestamp:(unsigned int)timestamp
{
    ...
    if (tableCtr != nil && tableCtr.butonTap ) {
        ...
        //yuv->image
        if (m_videoFormat == 2) {
            tableCtr.img = [APICommon YUV420ToImage:m_pYUVData width:m_nWidth height:m_nHeight] ;
        }
