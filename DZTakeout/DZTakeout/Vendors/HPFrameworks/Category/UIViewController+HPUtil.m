...
-(UIBarButtonItem *)barButtonItemWithTitle:(NSString *)title selectedTitle:(NSString *)selectedTitle normalColor:(UIColor *)normalColor highlightColor:(UIColor *)highlightColor selectedColor:(UIColor *)selectedColor normalImage:(UIImage *)normalImage highlightImage:(UIImage *)highlightImage target:(id)target action:(SEL)action{
    UIButton * button = [self buttonWithTitle:title highlightTitle:nil selectedTitle:selectedTitle disableTitle:nil
                                  normalColor:normalColor highlightColor:highlightColor selectedColor:selectedColor disableColor:nil
                                  normalImage:normalImage highlightImage:highlightImage selectedImage:nil disableImage:nil
                                       target:target action:action event:UIControlEventTouchUpInside];
    CGRect frame = button.frame;
    if (frame.size.width<30) {
