...
#import "CustomGLViewController.h"
...
@interface CustomGLViewController () {
    GLuint _program;
...
@implementation CustomGLViewController
...
{
    NSLog(@"WriteYUVFrame... length: %d, width: %d, height: %d",
          length, width, height);
    [m_YUVDataLock lock];
