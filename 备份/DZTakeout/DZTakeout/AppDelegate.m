...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self clearnApplicationIconBadgeNumber];
    [HPPayment setUpPayment];
    [HPIMManager initWithAppKey:@"z3v5yqkbz1jk0"];
    //设置红包扩展的Url Scheme。
    [[RCIM sharedRCIM] setScheme:@"DZrongcloudRedPacket" forExtensionModule:@"JrmfPacketManager"];
    //极光推送
...
-(void)setupJPUSH:(NSDictionary *)launchOptions{
    ...
    [JPUSHService setupWithOption:launchOptions appKey:@"8755aa67942daec6e4ce3c59"
                          channel:@"AppStore"
                 apsForProduction:NO
...
-(void)clearnApplicationIconBadgeNumber{
