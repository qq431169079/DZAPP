...
- (void)setRightView:(UIView *)rightView {
    ...
    if (_rightView) {
        ...
        [self.searchBarContainer mas_remakeConstraints:^(MASConstraintMaker *make) {
            @strongify(self);
        ...
        CGFloat offset = (SCREEN_WIDTH - 30 -size.width-26) *0.5;
        self.searchBarContainer.imageEdgeInsets = UIEdgeInsetsMake(8, offset-55, 8, offset+61);
    } else {
        @weakify(self);
        [self.searchBarContainer mas_remakeConstraints:^(MASConstraintMaker *make) {
            @strongify(self);
