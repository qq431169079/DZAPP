...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (model.type) {
        ...
        case 2://美食
        {
            FoodsBusinessDetailsViewController *foodsBusinessDetailsVC = [FoodsBusinessDetailsViewController controller];
            foodsBusinessDetailsVC.companyId = [NSString stringWithFormat:@"%ld",(long)model.cid];
            HPNavigationController *foodsBusinessDetailsNav = [[HPNavigationController alloc] initWithRootViewController:foodsBusinessDetailsVC];
            [self.getCurActiveViewController presentViewController:foodsBusinessDetailsNav animated:YES completion:nil];
        }
            break;
        case 3://酒店
        {
